...
class HSM_MailMonitor(object):
    ...
    def _handleResponses(self, newMsgs):
        ...
        for i in range(0, MESSAGES_PER_MAILBOX):
            ...
            if newMsgs[start:start_plus_one] == b"\0":
                continue
...
class SPM_MailMonitor:
    ...
    def _handleRequests(self, newMail):
        ...
        for host in range(0, self._numHosts):
            ...
            for i in range(0, MESSAGES_PER_MAILBOX):
                ...
                msgOffset_end = msgOffset + MESSAGE_SIZE
                ...
                if newMsg == CLEAN_MESSAGE:
                    ...
                    with self._outLock:
                        self._outgoingMail = (
                            ...
                            + CLEAN_MESSAGE
                            + self._outgoingMail[msgOffset_end:outMailLen]
                        )
                    send = True
                    continue
                ...
                try:
                    bumpedMsgStart = msgStart + 1
                    msgEnd = msgStart + 5
                    msgType = newMail[bumpedMsgStart:msgEnd]
    ...
    def sendReply(self, msgID, msg):
        ...
        with self._outLock:
            ...
            mailboxOffset_end = mailboxOffset + MAILBOX_SIZE
            mailbox = self._outgoingMail[mailboxOffset:mailboxOffset_end]
            cmd = self._outCmd + [
                'bs=' + str(MAILBOX_SIZE),
